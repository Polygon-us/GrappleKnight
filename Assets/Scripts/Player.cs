...
public class Player : MonoBehaviour
{
    ...
    [SerializeField]private float _horizontalForceOnGround;
    [SerializeField]private float _horizontalForceOnAir;
    ...
    private void FillSkillManager()
    {
     ...
     private void FillMovementManager()
     {
        ...
        currentMovable = new PlayerMover(transform,_rigidbody2D,_horizontalSpeed,_horizontalForceOnGround,
            _horizontalForceOnAir,_jumpForce,_raycastLength,_checkFloorMask);
